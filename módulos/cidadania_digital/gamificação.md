...
O Ciclo da Gamficiação incorpora uma sequência de 8 elementos essenciais para o sucesso de um sistema gamificado. São eles:

• Onboarding: trata-se do primeiro contato do usuário com o sistema gamificado. As primeiras impressões, a tomada de decisão em permanecer no sistema ou desistir de interagir com ele. De acordo com uma pesquisa da Microsoft, o tempo médio de atenção das pessoas habituadas com os meios digitais é de apenas 8 segundos. Isso significa que temos esse tempo para reter a atenção do usuário. Pense no Onboarding como a recepão do seu sistema. Se você atrair a atenção e cativar o público em 8 segundos, suas chances de mantê-lo aumentam consideravelmente e potencializam o uso da aplicação. Concentre, portanto, 1/3 dos seus recursos de desenvolvimento nos segundos iniciais de interação, criando um fluxo de informações relevantes a serem apresentadas de forma simples, objetiva e atraente. [Neste link](https://www.tecmundo.com.br/comportamento/80090-tempo-atencao-humano-menor-o-de-um-peixinho-dourado.htm) você poderá aprofundar o conhecimento sobre o tempo de retenção do usuário no uso das tecnologias modernas.

• Termos do Jogo: nesta etapa, é fundamental aprofundar e apresentar as regras do sistema de forma mais detalhada, demonstrando seu funcionamento. O jogo deve expor claramente as regras, mecânicas, progressão, formas de pontuação, prêmios que podem ser conquistados ou desbloqueados, desafios, objetivos e resultados esperados. [Este vídeo](https://www.youtube.com/watch?v=n-TLrm6-CZA) ensina os princípios básicos de Game Design que podem ser aplicados aos projetos de gamificação.

• Pontos: são a principal forma de mensurar os acertos em um sistema de gamificação. A partir da pontuação, definimos toda a mecânica do jogo, como o avanço dos usuários, sistemas de placares. São os pontos que indicam quanto cada elemento e cada ação vale na aplicação gamificada. Entretanto, para que funcione adequadamente, o sistema de pontuação deve focar sempre, no máximo, em três fatores importantes do jogo, para não confundir ou até mesmo atrapalhar o jogador. Esses fatores podem ser, por exemplo: a interação social, ações executadas no jogo, tarefas específicas, nível de engajamento, etc. Os três fatores escolhidos serão os OBJETIVOS do usuário dentro do sistema.Deve-se, ainda, definir qual é o objetivo principal (com uma pontuação maior) e os objetivos secundários (com pontuações menores).É importante lembrar que um sistema gamificado não tem (ou não deveria ter) fim, nunca termina, como acontece com a marioria dos jogos de entretenimento. Isso deve ser considerado para que mantenha-se um relacionamento duradouro e efetivo com o público. [Veja essas 8 dicas](https://www.moodlelivre.com.br/noticias/2593-8-dicas-para-gamificacao-baseada-em-pontos) para criar um sistema de gamificação baseado em pontos.
