...
Você já deve ter se deparado com um site te pedindo para aceitar cookies. Mas você já viu um cookie? Basta procurar no cabeçalho do HTTP, é por ele que o [cookie](https://en.wikipedia.org/wiki/HTTP_cookie) vem. O tal de cookie na vida real é lá tão simpático, mas olhando de perto é isso o que a vê!
...
$ `curl --help` mostra outras muitas possibilidades de uso do comando curl.
